...
public class GameLogic {
  ...
  public void setupLogic() {
    ...
    MainTimer.getTimerManager()
        .getTimer()
        .setEvent(() -> eventHandler.callEvent(EventHandler.Event.GAME_END));
  ...
  private void initialiseEvents() {
    ...
    eventHandler.createEvent(
        EventHandler.Event.SELECT_BUILDING,
        (params) -> {
    ...
    // Cancel all events
    eventHandler.createEvent(
        EventHandler.Event.CANCEL_OPERATIONS,
        (params) -> {
    ...
    eventHandler.createEvent(
        EventHandler.Event.SELL_BUILDING,
        (params) -> {
          // Delete the building
          world.demolish(gameState.selectedBuilding);
          // Refund the specified amount
          gameState.money +=
              gameState.selectedBuilding.getType().getCost() * Constants.sellCostRecovery;
    ...
    eventHandler.createEvent(
        EventHandler.Event.MOVE_BUILDING,
        (params) -> {
