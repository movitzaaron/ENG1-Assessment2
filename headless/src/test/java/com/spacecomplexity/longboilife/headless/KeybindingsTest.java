...
class KeybindingsTest {
    ...
    void testKeybindingsValues() {
        ...
        assertEquals(Input.Keys.D, Keybindings.CAMERA_RIGHT.getKey(), "CAMERA_RIGHT should map to D key");
        assertEquals(Input.Keys.Q, Keybindings.CAMERA_ZOOM_IN.getKey(), "CAMERA_ZOOM_IN should map to Q key");
        assertEquals(Input.Keys.E, Keybindings.CAMERA_ZOOM_OUT.getKey(), "CAMERA_ZOOM_OUT should map to E key");
        assertEquals(Input.Keys.F11, Keybindings.FULLSCREEN.getKey(), "FULLSCREEN should map to F11 key");
        ...
        assertEquals(Input.Keys.T, Keybindings.TUTORIAL_MENU.getKey(), "TUTORIAL_MENU should map to T key");
    }
}
