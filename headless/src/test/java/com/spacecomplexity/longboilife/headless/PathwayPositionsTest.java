...
/** Unit tests for the PathwayPositions enum. TEST REF : 7 */
...
public class PathwayPositionsTest extends AbstractHeadlessGdxTest {
  ...
  public void testConstructorAndGetters() {
    ...
    assertEquals(
        PathwayTextures.Type.STRAIGHT,
        top_bottom.getTextureType(),
        "Texture type should be set correctly");
    ...
    assertEquals(
        PathwayTextures.Type.CORNER,
        left_top.getTextureType(),
        "Texture type should be set correctly");
    ...
    assertEquals(
        PathwayTextures.Type.TJUNC,
        left_top_right.getTextureType(),
        "Texture type should be set correctly");
    ...
    assertEquals(
        PathwayTextures.Type.TJUNC,
        bottom_left_top.getTextureType(),
        "Texture type should be set correctly");
    ...
    assertEquals(
        PathwayTextures.Type.TJUNC,
        right_bottom_left.getTextureType(),
        "Texture type should be set correctly");
    ...
    assertEquals(
        PathwayTextures.Type.TJUNC,
        top_right_bottom.getTextureType(),
        "Texture type should be set correctly");
    ...
    assertEquals(
        PathwayTextures.Type.CROSS,
        top_left_bottom_right.getTextureType(),
        "Texture type should be set correctly");
  }
}
