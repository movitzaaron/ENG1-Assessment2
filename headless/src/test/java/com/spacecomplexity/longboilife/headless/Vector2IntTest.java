...
class Vector2IntTest {
    ...
    @Test
    @DisplayName("Test Vector2Int correctly returns false when equaling another Vector2Int but with different values")
    ...
    @Test
    @DisplayName("Test Vector2Int correctly returns true when equaling another Vector2Int but with the same values")
    ...
    @Test
    @DisplayName("Test Vector2Int correctly does not have the same hash code for a vector with different values")
    void testHashCodeDifferentValues() {
        Vector2Int v1 = new Vector2Int(5, 5);
        Vector2Int v2 = new Vector2Int(5, 6);
        assertNotEquals(v1.hashCode(), v2.hashCode(), "Different objects may have different hash codes");
    }

    @Test
    @DisplayName("Test Vector2Int correctly adds to form new vector with addition of x and y parts separately")
    void testAdd() {
        Vector2Int v1 = new Vector2Int(1, 2);
        Vector2Int v2 = new Vector2Int(3, 4);
    ...
    @Test
    @DisplayName("Test Vector2Int correctly subtracts to form new vector with subtraction of x and y parts separately")
    void testSubtract() {
